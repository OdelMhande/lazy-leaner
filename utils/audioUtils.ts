/**
 * Decodes a base64 string manually since atob/btoa might be deprecated or restricted in some envs,
 * but specifically requested by prompt rules to use custom logic if possible, 
 * strictly following the provided examples for Gemini PCM.
 */
 ...
 * Gemini 2.5 TTS returns raw PCM (Int16, 24kHz, Mono).
 */
